  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // شريط البحث — نفس روح/ستايل Opportunities
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  // لو عندك لون مخصص للـ Opportunities استخدميه هنا
                  fillColor: Theme.of(
                    context,
                      ...
                      >(
                        ...
                        builder: (context, cSnap) {
                          ...
                          return ListTile(
                            ...
                            // ملاحظة: ما نضيف أيقونة سهم هنا نهائيًا
                            // لو تبين فتح بروفايل عند الضغط على الاسم/الصورة فقط:
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                            ...
                            // زر Following (إلغاء المتابعة) — بدون أيقونة سهم
                            trailing: TextButton(
                              ...
                              onPressed: () async {
                                ...
                                _modified = true; // علّمنا إن صار تعديل
